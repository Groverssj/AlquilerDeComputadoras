...
namespace SistemaAlquilerDeComputadoras.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Ci,NombreCompleto,Cuenta,Edad,Password,Rol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Ci,NombreCompleto,Cuenta,Edad,Password,Rol")] Usuario usuario)
        {
            if (id != usuario.Ci)
            {
                return NotFound();
